const FaqHero = () => {
  return (
    <section
      className="w-full h-[50vh] px-10 sm:px-8 md:px-16 lg:px-[10.5rem] py-10 bg-center bg-cover bg-no-repeat flex flex-col"
      style={{
    ...
    >
      <div className="flex flex-col items-start my-auto justify-center">
        ...
        <p className="font-bold text-white text-3xl sm:text-4xl md:text-5xl">Frequently Asked Questions</p>
      </div>
    </section>
  );
};
