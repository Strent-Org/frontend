    ...
    <div className="flex-[2.6] flex flex-col gap-4 order-1 lg:order-2">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-wrap gap-2 items-center">
                <img className="w-5 h-5" src="/locationInnerShortlet.png" alt="Location" />
                <p className="text-[#1E1E1E] text-lg">Ikate Elegushi Lekki Lagos</p>
              </div>

              <h1 className="text-xl sm:text-2xl font-bold text-[#1E1E1E]">₦140,000/day</h1>
              <p className="text-sm sm:text-lg text-[#1E1E1E]">2 bedroom Flat & Apartment Short let Ikate Elegushi Lekki Lagos</p>
            ...
            <div className="flex flex-col gap-2 p-4 sm:p-6 bg-[#F9F9FF]">
              <h1 className="font-bold text-lg sm:text-xl text-[#1E1E1E]">Safety Tips</h1>
              ...
              {["Overview", "Location", "Video"].map((tab, i) => (
                <p
                  ...
                  className={`pb-2 cursor-pointer text-lg sm:text-2xl font-semibold ${
                    tab === "Overview" ? "border-b-2 border-[#4B3DFE]" : ""
                  }`}
                >
                  {tab}
                </p>
            ...
            <div className="flex flex-col gap-2 text-sm sm:text-base text-[#1E1E1E] leading-relaxed">
              ...
              <p>
                Live the Island Dream: Serenity, Style & Security in the Heart
                of VI.
              </p>
              <p>
                ...
                traveler, or a small family, this apartment offers you a
                lifestyle — not just a stay.
              </p>
              <p>
                Step into an impeccably furnished space, where warm lighting and
                tasteful décor wrap you in calm. The open living room invites
                you to unwind with a smart TV loaded with Netflix, YouTube, and
                Prime, while unlimited high-speed internet keeps you connected
                without compromise.
              </p>
              <p>
                Drift into dreamland in spacious queen-size bedrooms, or convert
                the second room into your private lounge, home office, or
                reading nook — the choice is yours. The standard bathrooms are
                sleek, functional, and designed with your comfort in mind.
              </p>
              <p>
                Laundry is never a worry with your in-house washer, dryer, and
                dedicated laundry room. A housekeeper is always on standby,
                ready to refresh your space and ensure every detail is perfect.
              </p>
              <p>
              ...
              <div className="flex flex-col">
                <p>
                  Your Victoria Island Getaway Includes:{" "}
                </p>
                <div className="mt-2">
                  <p>
                    2 large bedrooms (also perfect as 1 bed + lounge/office
                    setup)
                  </p>
                  <p>
                  ...
                  <p>
                    24/7 electricity & water treatment
                  </p>
                  <p>
                    Elevator access
                  </p>
                  ...
                  <p>
                    Secure, serene, stylish
                  </p>
                </div>
              </div>
              <p>
                The Eko Retreat is more than a stay — it's your personal slice
                of comfort, convenience, and class in the heart of Victoria
                Island.
              </p>
              <p>
            ...
            <div className="w-full border-2 rounded-xl py-4 px-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                <img className="w-10 h-10 sm:w-12 sm:h-12" src="/Vector.png" alt="Trusted Logo" />
                <div>
                  <h1 className="font-bold text-lg sm:text-xl">
                    Property is verified as real
                  </h1>
                  <p className="text-sm">If reported as fake, we'll investigate to confirm if</p>
                </div>
              </div>
              <button
                className="border border-[#4B3DFE] text-[#3A2EDB] px-4 py-2 rounded-lg font-semibold text-sm sm:text-base"
              >
                Report Property
              </button>
            </div>
            ...
            {/* Similar Listings */}
            <div className="flex flex-col gap-4">
                <h1 className="text-lg sm:text-xl font-bold text-[#1E1E1E]">Similar Listings</h1>
                <ShortletCards />
                <ShortletCards />
                <ShortletCards />
            </div>
