  ...
  return (
    <>
      <main className="flex flex-col items-center justify-center text-center h-auto w-full overflow-x-hidden">
        <section
          id="hero-section"
          className="lg:h-[470px] flex flex-col items-center justify-center w-full p-[4%] bg-cover bg-center bg-no-repeat"
          style={{
        ...
        >
          ...
          <div className="bg-black/70 py-6 lg:px-4 rounded-md w-full lg:h-[140px] md:w-[70%] lg:w-[50%] xl:w-[632px] font-inter">
            <form action="" className="flex flex-col gap-6 items-center">
              <div className=" flex gap-2 flex-col lg:h-[48px] sm:flex-row sm:gap-0 items-center justify-center w-full">
                <div className="w-2/3 relative lg:h-[48px]">
                  <img
                    src={`${SearchIcon}`}
                    alt="search"
              ...
              <div className="flex gap-1 sm:gap-2 lg:gap-6 justify-center flex-wrap">
                <select
                  id="property-type"
        ...
        <section
          ...
          className="py-10 px-[10%] text-sm bg-neutral w-full mb-[5%] flex flex-col gap-8 relative"
        >
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-10 text-left">
              {bestRental.map((apt) => {
                return (
                  <article
                    key={apt.id}
                    className="mb-2 flex flex-col gap-2 font-inter"
                  >
                    <img
                      src={apt.imageUrl}
                      alt={apt.title}
