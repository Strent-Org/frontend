        ...
        >
          ...
          <span>
            ...
            {isOpen ? (
              <img
                src={ArrowUp}
                className="text-white p-1 min-w-[48px] bg-primary"
              />
            ) : (
              <img
                src={ArrowDown}
  ...
  return (
    <>
      <main className="flex flex-col items-center justify-center text-center h-auto w-full overflow-x-hidden">
        ...
        >
          <div className="pb-1 font-sora px-6">
          ...
          <div className="flex  w-fit text-base my-3 font-inter">
            ...
            <button className="bg-white py-2 px-6 rounded-md">Shortlet</button>
          </div>
              ...
              <div className=" flex gap-2 flex-col  sm:flex-row sm:gap-0 items-center justify-center w-full">
                <div className="w-2/3 relative">
                  <img
                    src={`${SearchIcon}`}
                    alt="search"
                    className="absolute left-0 mt-1 ml-2"
                  />
                  <input
                    type="text"
                    id="search"
                    className="w-full p-2 pl-10 text-sm rounded-lg sm:rounded-r-none focus:outline-none"
        ...
        <section
          ...
          className="py-10 px-[10%] text-sm bg-neutral w-full mb-[5%] flex flex-col gap-4 relative"
        >
          {/* <div id="chat-icon">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-2 text-left">
              {topRental.map((apt) => {
                return (
                  <article
                    key={apt.id}
                    className=" mb-2  min-w-[170px] max-w-[220px] font-inter"
                  >
                    <img
                      src={apt.imageUrl}
                      alt={apt.title}
        ...
        <section
          id="neighbourhood"
          className="py-2 px-[10%] text-sm w-full mb-[5%]"
        >
