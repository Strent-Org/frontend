      ...
      <div className="max-w-7xl mx-auto px-12 py-8 grid grid-cols-1 lg:grid-cols-4 gap-10">
        ...
        <aside className="space-y-6 order-1 lg:order-1">
          ...
          <div className="bg-white w-full rounded-lg p-6 border border-[#DDDDE1] font-inter">
            ...
            <select className="w-full mb-3 border rounded p-2 text-[#B9B9B9] text-sm">
          ...
          <div className="bg-white rounded-lg p-6 border border-[#DDDDE1] font-inter">
            ...
            {listings.slice(0, 3).map((listing, i) => (
              <Link
                ...
                className="flex gap-3 mb-6 hover:bg-gray-50 p-2 rounded transition-colors"
              >
                <img
                  src={ListImage}
                  alt="Listing"
                ...
                />
                <div>
                  <h3 className="text-sm mb-1 hover:text-[#4B3DFE]">
                    {listing.title}
                  </h3>
        ...
        <main className="lg:col-span-3 order-2 lg:order-2">
          ...
          <div className="space-y-6">
            {listings.map((listing) => (
              <div
                key={listing.id}
                className="bg-white rounded-lg border border-[#DDDDE1] p-6 flex flex-col lg:flex-row gap-6"
              >
                {/* Image */}
                <Link
                  to={`/listing/${listing.id}`}
